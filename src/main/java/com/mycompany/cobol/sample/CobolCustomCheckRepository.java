...
import com.mycompany.cobol.sample.checks.ToKeywordPositionCheck;
...
public class CobolCustomCheckRepository implements CobolCheckRepository, RulesDefinition {
  ...
  private static final String REPOSITORY_KEY = "TO-Position-check";
  private static final String REPOSITORY_NAME = "TO-Position-Cobol-Analyzer";
  ...
  public void define(Context context) {
    ...
    remediationCosts.put("ToKeywordPositionCheck","5min");
